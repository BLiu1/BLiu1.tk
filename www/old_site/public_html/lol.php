...
<head>
	<meta charset="utf-8" />
	<title>BLiu1's Website - LOL Not Found</title>
	...
	<style>#not_found{color: red;}</style>
...
<section>
	<h2 id="not_found"><img src="/images/404.png" alt="404" /> LOL&nbsp;Not&nbsp;Found</h2>
	<p>I'm sorry, but there is no page on this website with that web address.</p>
	<p>Try <a href="/tlc.php">tlc.php</a></p>
</section>
