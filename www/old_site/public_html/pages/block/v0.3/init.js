...
var getEl = function(el) {return document.getElementById(el);},
    addEvent = function(obj, evt, fnc) {/*https://gist.github.com/eduardocereto/955642*/if(obj.addEventListener){obj.addEventListener(evt,fnc,false);return true;}else if(obj.attachEvent){return obj.attachEvent('on'+evt,fnc);}else{evt='on'+evt;if(typeof obj[evt]==='function'){fnc=(function(f1,f2){return function(){f1.apply(this,arguments);f2.apply(this,arguments);}})(obj[evt],fnc);}obj[evt]=fnc;return true;}return false;};
...
var canvas = getEl('canvas'),
    ...
    width  = canvas.width  = TILE * tileWidth,
    height = canvas.height = TILE * tileHeight;
